...
public class PointOfInterestClient {
    ...
    public PointOfInterestClient(Activity a, DisposableSingleObserver<PointsOfInterest> ds) {
        this.activity = a;
        RetrofitClient retrofit = new RetrofitClient();
        PointsOfInterestService pointsOfInterestService = retrofit.getRetrofitV1().create(PointsOfInterestService.class);
